...
namespace PeliculasCategoria.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CategoriasController : ControllerBase
    {
        private readonly PeliculasCategoriaContext _context;

        public CategoriasController(PeliculasCategoriaContext context)
        {
            _context = context;
        }
